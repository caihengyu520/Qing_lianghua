...
from _weights_ import weights_matrix
random.seed(100)
...
class Producer(threading.Thread):  # 生产者类
    def __init__(self,data,data_2,i_p_condition,condition,resources, goods,goods_1,test_x,test_y,weights_1,count_=1, sleeptime=2):  # sleeptime=2
        threading.Thread.__init__(self)
        self.i_p_condition=i_p_condition
        self.cond = condition
        self.goods = goods
        ...
        while True:
            ...
            while True:
                ...
                if goods.empty():
                    ...
                    jishuqi+=1
                    resources.acquire()
                    decoder2,X_1,tst_1=load_model(sess1,data_2.get_train_data(),data_2.get_train_label(),self.weights_1,flag)
                    resources.release()
                result_1, precison_1 = compute_accuracy(data_2.get_train_data(), data_2.get_train_label(), sess1,X_1,tst_1, decoder2)
                print('produce_result_1:', result_1)
                print('produce_precision_1:', precison_1)
                result_1_, precison_1 = compute_accuracy(test_x, test_y, sess1, X_1,
                                                        tst_1, decoder2)
                print('produce_result_1:', result_1_)
                print('produce_precision_1:', precison_1)
...
class Consumer(threading.Thread):  # 消费者类
    def __init__(self,data,condition,resources, goods, test_x,test_y,weights_1,count_,sleeptime=1):  # sleeptime=1
        threading.Thread.__init__(self)
        self.cond = condition
        self.goods = goods
        self.sleeptime = sleeptime
    ...
    def run(self):
        ...
        while True:
            ...
            if self.count_ == 1:
                X_3, tst_3,  decoder2_3,e1_value, e2_value, e3_value, e4_value, e5_value, e6_value, e7_value, e8_value = load_model_3(
                    sess3,X_3,tst_3,decoder2_3,encoder2_3, train_data, train_label,train_len,resources,goods,self.weights_1)
            else:
                X_3, tst_3, decoder2_3,e1_value, e2_value, e3_value, e4_value, e5_value, e6_value, e7_value, e8_value = load_model_3_1(
                    sess3,X_3,tst_3,decoder2_3,encoder2_3, train_data, train_label,train_len,resources,goods,self.weights_1)
            self.count_ += 1
            ...
            result_1, precison_1 = compute_accuracy_(test_x, test_y, sess3,X_3,tst_3,decoder2_3)
            print('consumer_result_1:', result_1)
            print('consumer_precision_1:', precison_1)
            sess3.close()
            cond.release()
...
pro = Producer(data_1,data_2,i_p,c,resources,g,g_1,test_x_,test_y_,weights_1,count_=1)
pro.start()

con = Consumer(data_2,c,resources,g,test_x,test_y,weights_1,count_=2)
con.start()
